<template>
  <div class="bg-gray-100 h-fit lg:mt-[-30px]  justify-center">
    <center class=" pt-32 pb-40 m-auto">
      <svg
        class="emoji-404"
        ...
        xml:space="preserve"
      >
        <circle cx="113" cy="113" fill="#FFEA00" r="109" />
        <line
      ...
      <div class="tracking-widest mt-4">
        ...
        <span class="text-gray-500 text-xl"
          ><span class=" font-bold">OOPS!</span> THAT PAGE CAN’T BE FOUND</span
        >
      </div>
    </center>
  </div>
